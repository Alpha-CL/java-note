package src.java.Advance.Box.ArrayBox;
...
public class ArrayBox<E> {
    ...
    public void printlnArr() {
        ...
        System.out.println("<!-- println src.java.Advance.array start -->");
        for (int i = 0; i < arr.length; i++) {
            System.out.println("arr[" + i + "]: " + arr[i]);
        }
        System.out.println("<!-- println src.java.Advance.array end -->");
    }
