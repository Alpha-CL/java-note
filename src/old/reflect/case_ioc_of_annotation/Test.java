...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Person person = (Person) ms.getBean("src.old.reflect.case_ioc_of_annotation.Person");
        ...
        Identity identity = (Identity) ms.getBean("src.old.reflect.case_ioc_of_annotation.Identity");
        @SuppressWarnings("all")
        ...
        Question question = (Question) ms.getBean("src.old.reflect.case_ioc_of_annotation.Question");
        @SuppressWarnings("all")
